...
<html lang="en">
    ...
    <body>
             <section class=" bg-warning bg-warning bg-gradient" id="products">
        <!-- Navigation-->
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">We Accept Custom Cakes</h1>
                    <p class="lead fw-normal text-white-50 mb-0 "> <a class="btn btn-outline-warning btn-xl text-uppercase" href="https://www.facebook.com/profile.php?id=100057389083010&sk=photos_albums" target="_blank">Click here to view samples</a></p>     
                </div>
            </div>
        </header>
        <!-- Section-->
